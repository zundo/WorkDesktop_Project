const express = require('express'),
    ...
    cors = require('cors'),
    registerCtrl = require('./src/register'),
    schoolCtrl = require('./src/school'),
    facultyCtrl = require('./src/faculty'),
    userCtrl = require('./src/user'),
    loginCtrl = require('./src/login'),
    app = express(),
...
app.get('/users', userCtrl.getUserByType)

app.put('/user/:id', userCtrl.updateUser)

app.delete('/user/:id', userCtrl.deleteUser)

app.post('/school/register', schoolCtrl.register)

app.get('/school', schoolCtrl.getSchools)

app.get('/school/:id', schoolCtrl.getSchool)

app.put('/school/:id', schoolCtrl.updateSchool)

app.post('/school/:id/faculty', facultyCtrl.register)

app.post('/faculty/user', facultyCtrl.userFacultyRegister)

app.put('/faculty/:id', facultyCtrl.updateFaculty)

app.get('/faculty/:id', facultyCtrl.getUserFaculty)
